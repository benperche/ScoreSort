...
- **Customizable instrument order** - edit, reorder, add, or remove instruments
...
5. **Customize preferences** (optional)
...
5. **Customize filenames** (optional)
   - Set a base filename (auto-numbered)
   - Or click "Customize Names" for individual names
...
- **Claude** - free version, not even Claude Code.
...
All orders are fully customizable in Preferences.
...
- [ ] Fix the broken PDF viewer in the splitter
...
- Originally inspired by a Python-based sheet music renamer, also generated by Claude
- Built for musicians, by AI and one musician
