...
| `PreferredInstrumentNameTests` | `preferredInstrumentDisplayName(_:)` — sax family (any spelling/order) → full "X Saxophone"; non-sax names unchanged |
