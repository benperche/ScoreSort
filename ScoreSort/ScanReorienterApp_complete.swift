    ...
    static let all: [WelcomeTourPage] = [
        ...
        WelcomeTourPage(
            ...
            bodyParagraphs: [
                ...
                "Which way to turn the paper depends on the printer, so ScoreSort only applies it when *it* is doing the printing. **Create PDF** and **Open in Preview** always give you a booklet that reads the right way up on screen — an ordinary file you can check, keep, or hand to whoever is doing the printing. All they need to know is: print it **double-sided**, choose whichever two-sided setting brings the backs out the right way up, then fold and staple.",
