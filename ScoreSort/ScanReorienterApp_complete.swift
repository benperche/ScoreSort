    ...
    static let all: [WelcomeTourPage] = [
        ...
        WelcomeTourPage(
            ...
            bodyParagraphs: [
                ...
                "Because that flip depends on your printer, it's applied only when printing. **Create PDF** and **Open in Preview** always give you an upright booklet you can read on screen — so print booklets straight from ScoreSort with **Print…**, rather than saving and printing the file from somewhere else.",
